...
--entities=ks1 --rename=ks1.tb2=ks1.tb2
--entities=ks1.tb1,ks1.tb2,ks1.tb3 --rename=ks1.tb2=ks1.tb3
----

* keyspace in "from" entity (ks1.tb1) has to be same in "to" entity (ks1.tb2), in case it differs, it will error out.
In other words, you can not restore a table across a keyspace.
* entities in "to" have to be unique across all renaming pairs, "ks1.tb1=ks1.tb2" and "ks1.tb3=ks1.tb2" is invalid
