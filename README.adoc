...
* listing of local backups and their removal, global removal of backups across all nodes in cluster
...
This feature is for now only available for `file://`-based backups and `s3://`-based backups.
...
nice to be able to delete, for example, all backups older than 14 days, globaly. "Globally" means
