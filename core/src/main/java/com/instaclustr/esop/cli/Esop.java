...
public class Esop extends CLIApplication implements Runnable {
    ...
    static void init(final Runnable command,
        ...
        modules.add(new LocalFileModule());
    ...
    public static List<Module> getStorageSpecificModules()
    {
        List<Module> modules = new ArrayList<>();
        for (SPIModule module : ServiceLoader.load(SPIModule.class)) {
            modules.add(module.getGuiceModule());
        }
