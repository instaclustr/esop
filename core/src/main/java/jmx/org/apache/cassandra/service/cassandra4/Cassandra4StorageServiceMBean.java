...
public interface Cassandra4StorageServiceMBean extends NotificationEmitter
{
    /**
     ...
     * @return status of parent repair from enum org.apache.cassandra.repair.RepairRunnable.Status
     ...
     * Note this becomes false before org.apache.cassandra.db.SystemKeyspace#bootstrapComplete() is called,
